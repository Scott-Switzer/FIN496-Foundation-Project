...
- Net Sharpe improves by 0.34 versus `BM2`, while the Deflated Sharpe Ratio is 1.000 across 5 disclosed TAA trials. [Sources: `taa_project/outputs/portfolio_metrics.csv`, `taa_project/outputs/dsr_summary.csv`, `TRIAL_LEDGER.csv`]
...
- This run achieved -34.55% maximum drawdown against the IPS tolerance of -25%. The submission-selection summary was not available in this output directory.
