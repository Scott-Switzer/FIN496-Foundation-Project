...
- Net Sharpe improves by 0.11 versus `BM2`, while the Deflated Sharpe Ratio is 0.839 across 268 disclosed trials in `TRIAL_LEDGER.csv`. [Sources: `taa_project/outputs/portfolio_metrics.csv`, `taa_project/outputs/dsr_summary.csv`, `TRIAL_LEDGER.csv`]
...
- This run achieved -16.59% maximum drawdown against the IPS tolerance of -25%. The submission-selection summary was not available in this output directory.
