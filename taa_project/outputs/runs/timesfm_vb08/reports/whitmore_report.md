...
- Net Sharpe improves by 0.11 versus `BM2`, while the Deflated Sharpe Ratio is 0.853 across 235 disclosed trials in `TRIAL_LEDGER.csv`. [Sources: `taa_project/outputs/portfolio_metrics.csv`, `taa_project/outputs/dsr_summary.csv`, `TRIAL_LEDGER.csv`]
...
## Performance Results
- `SAA+TAA` delivers 5.70% annualized return, 5.12% annualized volatility, and -16.63% max drawdown. [Source: `taa_project/outputs/portfolio_metrics.csv`]
