...
- Net annualized return is 10.91% for `SAA+TAA` versus 8.83% for `SAA` and 7.86% for `BM2`. [Source: `taa_project/outputs/portfolio_metrics.csv`]
- Net Sharpe improves by 0.45 versus `BM2`, while the Deflated Sharpe Ratio is 0.996 across 138 disclosed TAA trials. [Sources: `taa_project/outputs/portfolio_metrics.csv`, `taa_project/outputs/dsr_summary.csv`, `TRIAL_LEDGER.csv`]
...
## Performance Results
- `SAA+TAA` delivers 10.91% annualized return, 8.44% annualized volatility, and -27.56% max drawdown. [Source: `taa_project/outputs/portfolio_metrics.csv`]
- Relative to `SAA`, the TAA overlay changes annualized return by 2.08% and cost drag by 0.06% per year. [Source: `taa_project/outputs/portfolio_metrics.csv`]
